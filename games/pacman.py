...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption('self.pacman')
    ...
    def start_game(self):
        ...
        # default locations for self.pacman and ghosts
        w = 303 - 16  # Width
        p_h = 7 * 60 + 19
        m_h = 4 * 60 + 19
        b_h = 3 * 60 + 19
        ...
        self.pacman = Player(w, p_h, 'images/self.pacman.png')
        ...
        while not done:
            ...
            self.pacman.update(wall_list, gate)
            ...
            # See if the self.pacman block has collided with anything.
            blocks_hit_list = pygame.sprite.spritecollide(self.pacman, block_list, True)
            ...
            ghost_hit_list = pygame.sprite.spritecollide(self.pacman, ghost_list, False)
    ...
    def do_next(self, message, left, block_list, ghost_list, pacman_collide, wall_list, gate):
        ...
        :param ghost_list:
        :type ghost_list:
        :param self.pacman_collide:
        :type self.pacman_collide:
        :param wall_list:
        :type wall_list:
        :param gate:
        :type gate:
